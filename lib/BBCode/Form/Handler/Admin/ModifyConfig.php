...
class BBCode_Form_Handler_Admin_ModifyConfig extends Zikula_Form_AbstractHandler
{
    ...
    function initialize(Zikula_Form_View $view)
    {
        ...
        $view->assign('quote_preview', nl2br(ModUtil::apiFunc('BBCode', 'user', 'transform', array('message' => "[quote=username]test\ntest test\n[/quote]"))));
        ...
        $view->assign('code_preview', ModUtil::apiFunc('BBCode', 'user', 'transform', array('message' => "[code=php, start=100]<?php\necho 'test';\n?>[/code]")));
