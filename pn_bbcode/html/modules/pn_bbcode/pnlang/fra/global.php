...
define('_PNBBCODE_BBCODE_CODE_HINT', 'insérer du code');
...
define('_PNBBCODE_BBCODE_COLOR_DARKBLUE', 'Bleu foncé');
define('_PNBBCODE_BBCODE_COLOR_DARKRED', 'Rouge foncé');
define('_PNBBCODE_BBCODE_COLOR_DEFAULT', 'Standard');
define('_PNBBCODE_BBCODE_COLOR_DEFINE', 'couleur personnalisée');
define('_PNBBCODE_BBCODE_COLOR_GREEN', 'Vert');
define('_PNBBCODE_BBCODE_COLOR_HINT', 'sélectionner la couleur du texte');
...
define('_PNBBCODE_BBCODE_ENTER_EMAIL_ADDRESS','Entrez l\'adresse email que vous désirez ajouter :');
...
define('_PNBBCODE_BBCODE_ENTER_TEXT_UNDERLINE','entrez le texte à souligner');
define('_PNBBCODE_BBCODE_ENTER_URL','Entrez l\'URL du lien à ajouter :');
...
define('_PNBBCODE_BBCODE_IMAGE_HINT', 'insérer une image');
...
define('_PNBBCODE_BBCODE_LISTITEM_HINT', 'élément de liste');
...
define('_PNBBCODE_BBCODE_MAIL_HINT', 'insérer une adresse email');
define('_PNBBCODE_BBCODE_QUOTE', 'Quote');
define('_PNBBCODE_BBCODE_QUOTE_HINT', 'insérer une citation');
define('_PNBBCODE_BBCODE_SIZE_DEFINE', 'taille personnalisée');
define('_PNBBCODE_BBCODE_SIZE_HINT', 'Sélectionner la taille de la police');
define('_PNBBCODE_BBCODE_SIZE_HUGE', 'Géant');
...
define('_PNBBCODE_BBCODE_UNDERLINE_HINT', 'texte souligné');
define('_PNBBCODE_BBCODE_URL', 'URL');
define('_PNBBCODE_BBCODE_URL_HINT', 'insérer un lien');
