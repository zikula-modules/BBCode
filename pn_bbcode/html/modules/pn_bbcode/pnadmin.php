 ...
 *
 */
function pn_bbcode_admin_miscconfig()
{
    if (!SecurityUtil::checkPermission('pn_bbcode::', "::", ACCESS_ADMIN)) {
        return LogUtil::registerPermissionError('index.php');
    }

    Loader::requireOnce('modules/pn_bbcode/pnincludes/pn_bbcode_admin_miscconfighandler.class.php');

    // Create output object
    $pnf = FormUtil::newpnForm('pn_bbcode');

    // Return the output that has been generated by this function
    return $pnf->pnFormExecute('pn_bbcode_admin_miscconfig.html', new pn_bbcode_admin_miscconfighandler());
}
